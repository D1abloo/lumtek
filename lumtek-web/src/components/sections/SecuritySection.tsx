            ...
            {securityBlocks.map((block, i) => {
              ...
              return (
                <AnimatedReveal key={block.title} delay={i * 0.04}>
                  <article className="h-full rounded-2xl border border-lumtek-border bg-white p-5 shadow-soft">
                    <Icon className="mb-3 h-5 w-5 text-lumtek-blue" strokeWidth={1.75} />
